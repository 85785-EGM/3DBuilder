...
import { MeshBVHVisualizer, MeshBVH, CONTAINED, INTERSECTED, NOT_INTERSECTED } from '..'
...
function init () {
  ...
  mesh.geometry.setAttribute(
    'color',
    new THREE.Uint8BufferAttribute(new Array(mesh.geometry.index.count * 3).fill(255), 3, true)
  )
